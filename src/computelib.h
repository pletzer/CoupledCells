...
void compute(const grid_parms&, SMC_cell** const, EC_cell** const, const conductance& cpl_cef, double, double*, double*);
...
int map_solver_output_to_cells(const grid_parms&, double*, SMC_cell** const, EC_cell** const);
